...
| `FIL_23` | `modelado/requirements.txt`: `torch>=2.2,<3` sin índice CPU resuelve al build CUDA (~4.5 GB, roto sin GPU) — hallazgo de `VIKT_08` | ⬜ **pendiente** — reproducibilidad, `modelado/` |
