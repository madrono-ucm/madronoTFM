...
## Handler Lambda (tarea 026): solo `sweep_premieres`, no `fetch_cinema_showtimes`
...
def lambda_handler(event, context):
    """Punto de entrada AWS Lambda (tarea 026): estrenos de la semana completos a Bronze real."""
