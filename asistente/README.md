...
| `meteo_cercana(lugar, radio_m=1500)` | meteorología observada (temp/viento/precip/humedad) en la estación `:EstacionMedida{meteo}` más cercana del grafo + `gold.meteorologia_por_estacion_magnitud_hora` | `FIL_82` |
