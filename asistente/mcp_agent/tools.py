...
`eventos_cercanos` (tarea 091) ya leen datos reales; solo
...
# Tabla Silver, no Gold (tarea 091 -- caso deliberadamente distinto al resto
...
# 091): Silver de `agenda_eventos` tiene cientos de particiones `fecha=`
# reales que llegan hasta 2029 (eventos anunciados con mucha antelación,
# ver doc/091-...md) -- sin acotar, "eventos cercanos" incluiría conciertos
...
def _eventos_cercanos_impl(
    ...
    *,
    ...
    # confirmado contra datos reales en la tarea 091 (un mismo `event_id`
...
def eventos_cercanos(
    ...
    próximos 30 días (tarea 091: implementación real, ver
    `asistente/README.md`).
