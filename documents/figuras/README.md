...
| 3 | `04_secuencia_consulta.mmd` | §6.7 — secuencia de una consulta al asistente |
| 4 | `03_pipeline_ml.mmd` | §7.2 — pipeline de `modelado/` |
| 5 | `grafo_resiliencia.png` (en `modelado/evaluation/artifacts/`, no aquí) | §7.3 — curva de robustez del grafo |
