...
<div class="panel" id="controls">
  <details open id="g-historia">
    <summary>📖 Historia · recorrido guiado</summary>
    ...
    <div class="row" style="margin-top:4px">
      <button id="hist-prev" aria-label="Capítulo anterior">◀</button>
      <button id="hist-auto" aria-label="Reproducir el capítulo">▶ animar</button>
      <button id="hist-next" aria-label="Capítulo siguiente">▶</button>
    </div>
  </details>
  <details open>
  ...
  <details id="g-chat">
    <summary>💬 Preguntar a los datos (asistente)</summary>
    <div class="muted" style="margin:2px 0 4px">Lenguaje natural → el asistente (Groq + 15 herramientas
...
// ---- Chat con el asistente (Groq + herramientas MCP sobre grafo/Gold) -------
...
Promise.all([
  ...
  mkControls(); mkHistoria(); mkChat(); syncTabs();
