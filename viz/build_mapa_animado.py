...
// nativa. Estilos Carto sin token; "ninguno" es un estilo vacío
// (transparente) para el modo sin tiles / capturas offline.
...
const estiloBase = () => BASEMAPS[state.basemap] || BASEMAP_VACIO;
...
function mkControls(){
  ...
  bmSel.onchange = ()=>{
    ...
    // El MapboxOverlay es un control del mapa, así que sobrevive al cambio de
    // estilo y las capas siguen ancladas; se repintan al terminar de cargar.
