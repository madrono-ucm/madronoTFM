...
| Hecho después del spine | `FIL_42` hosting · `FIL_37` como **12.ª tool MCP** (`ruta_saludable`) · `FIL_38` backtest MTD (STGNN bate persistencia: skill +0,37 / +0,70 / +0,85 a h1/h3/h6) · `FIL_43` métrica de ruta = la que Dijkstra minimiza (0 negativas) · `FIL_47/48/49` legibilidad + pulido + barras 3D · `FIL_45` capa social (9 perfiles, bandas OMS·UE, dosis, mejor hora) |
